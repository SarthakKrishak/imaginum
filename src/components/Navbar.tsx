...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-[12vh] px-6 md:px-[6.2rem] z-20 w-full lg:pt-4">
      <Link to={"/"} className="text-white font-bold text-3xl"><h1>Imaginum</h1></Link>
