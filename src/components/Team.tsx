...
export default function Team() {
  ...
  return (
    <section aria-labelledby="team-heading">
      <div className="text-white font-geist font-bold text-2xl md:text-3xl px-6 md:px-[6rem] flex flex-col gap-4 md:mt-36 mt-24 mb-10">
      ...
      <div className="flex flex-col gap-6 lg:gap-12 items-center justify-center md:flex-row md:flex-wrap px-6 md:px-20">
        {teamMembers.map((member, index) => (
          <motion.article
            ...
            viewport={{ once: true }}
            className="w-[85vw] sm:w-[70vw] md:w-[45vw] lg:w-[18vw] bg-gradient-to-tl from-[#000000] to-[#002774] border border-[#575757] rounded-xl overflow-hidden flex flex-col"
          >
            {/* Top Section */}
