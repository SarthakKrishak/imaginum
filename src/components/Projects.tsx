  ...
  return (
    <>
      ...
      <motion.img
        ...
        className="absolute h-28 md:h-40 md:top-[112rem] md:left-32 left-2 top-[121rem] z-20 cursor-grab active:cursor-grabbing md:block"
      ...
      <motion.div
        ...
        className="text-white font-geist font-bold text-2xl md:text-3xl px-6 md:px-[6rem] flex flex-col gap-4 mt-48"
      >
      ...
      <motion.div
        ...
        className="px-6 md:px-[6rem] text-3xl md:text-6xl mt-4"
      >
