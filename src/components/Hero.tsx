    ...
    <>
      ...
      >
        <div className="flex flex-col items-center gap-6 text-center mt-6 ms:mt-4 md:mt-0">
          ...
          <motion.h1
            className="font-bold text-white text-[1.35rem] sm:text-[1.3vw] md:text-[3rem] capitalize leading-[140%]"
        ...
        <motion.img
          ...
          loading="lazy"
          className="absolute h-28 md:h-40 md:top-[22rem] md:left-6 left-[-12vw] top-[29rem] cursor-grab active:cursor-grabbing"
        />
        ...
        <motion.img
          ...
          alt="Rotating element image"
          loading="lazy"
          className="absolute h-24 md:h-28 top-[8rem] md:right-12 right-[-12vw] cursor-grab active:cursor-grabbing"
        />
      </motion.div>
    </>
  );
